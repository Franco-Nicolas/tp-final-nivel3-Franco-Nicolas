...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--Función para mostrar un mensaje por un determinado tiempo.--%>
        ...
        <asp:Repeater runat="server" ID="repRepetidorDetalle">
            <ItemTemplate>
                <div class="card mb-2">
                    <div class="row g-5">
                        <div class="col-md-6">
                            <img class="card-img-top-detalle mb-5 mb-md-0" src="<%#Eval("ImagenUrl") %>" alt="Imagen del articulo" onerror="this.onerror=null; this.src = 'https://www.nycourts.gov/courts/ad4/assets/Placeholder.png'" />
                        </div>
                        <div class="col-md-6 card-body-detalle">
